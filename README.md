...
| applications.loki.enabled | bool | `false` | loki enable: 'true', 'false' |
...
| applications.mongodb.enabled | bool | `false` | mongodb enable: 'true', 'false' |
...
| applications.mysql.enabled | bool | `false` | mysql enable: 'true', 'false' |
...
| applications.promtail.enabled | bool | `false` | promtail enable: 'true', 'false' |
...
| applications.strimzi.enabled | bool | `false` | strimzi enable: 'true', 'false' |
...
| applications.tempo.enabled | bool | `false` | tempo enable: 'true', 'false' |
...
| traces.enabled | bool | `false` | traces enable: 'true', 'false' |
